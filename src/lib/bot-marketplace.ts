...
export const MARKETPLACE: BotTemplate[] = [
  ...
  },
  {
    ...
    rating: 4.5,
    installs: 15670,
    desc: "Koopt bij op dips via TradingView webhook. Sterk in trending markten zoals goud & indices.",
  ...
  },
  {
    ...
    symbols: ["XAUUSD", "NAS100", "CL", "EURUSD"],
    timeframe: "H4",
    risk: "Middel",
    params: [
